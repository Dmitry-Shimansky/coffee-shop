  ...
  <main>
    <div class="banner contactspage-banner">
      <div class="container">
        ...
        <header-title titleText="Contact us"></header-title>
      </div>
    </div>
            ...
            <form @submit.prevent="submit" action="#" class="mt-5">
              <div class="form-group row">
                ...
                <div class="col col-12 col-sm-9">
                  ...
                  <span v-for="error in v$.name.$errors" :key="error.$uid">{{ error.$message }}
                  </span>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col col-12 col-sm-9">
                  ...
                  <span v-for="error in v$.phone.$errors" :key="error.$uid">{{ error.$message }}
                  </span>
                </div>
              </div>
